...
tar xjf ${version}-major-${arch}-linux.tar.bz2
sudo mv ${version}-major /usr/share/${version}/
...
sudo ln -s /usr/share/${version}/bin/arm-none-eabi-objcopy /usr/bin/arm-none-eabi-objcopy
